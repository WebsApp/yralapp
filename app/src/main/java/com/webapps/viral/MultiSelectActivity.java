...
public class MultiSelectActivity extends AppCompatActivity implements AlertDialogHelper.AlertDialogListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.addOnItemTouchListener(new RecyclerItemClickListener(MultiSelectActivity.this, recyclerView, new RecyclerItemClickListener.OnItemClickListener() {
            @Override
