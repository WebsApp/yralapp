...
public class AllLikerActivity extends AppCompatActivity {
    ...
    public  void GetUSer()
    {
        ...
        Call<ArrayList<Follower>> userCall = service.GetLiker(id);
            ...
            public void onResponse(Call<ArrayList<Follower>> call, Response<ArrayList<Follower>> response) {
                ...
                try {
                    ...
                    if(category.size()>0) {
                        ...
                        foodAdapter = new FollowerAdapter(AllLikerActivity.this,category);
