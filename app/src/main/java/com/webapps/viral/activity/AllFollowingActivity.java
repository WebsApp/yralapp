...
import com.webapps.viral.adapter.FollowingAdapter;
...
public class AllFollowingActivity extends AppCompatActivity {
    ...
    public  void GetUSer()
    {
        ...
        Call<ArrayList<Follower>> userCall = service.GetFollowing(id);
            ...
            public void onResponse(Call<ArrayList<Follower>> call, Response<ArrayList<Follower>> response) {
                ...
                try {
                    ...
                    if(category.size()>0) {
                        ...
                        foodAdapter = new FollowingAdapter(AllFollowingActivity.this,category);
