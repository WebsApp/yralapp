...
public class OTPModel {
    ...
    public class Data {
        ...
        @Expose
        private String userLocationUpdated;
        ...
        @Expose
        private String userAlbumTimeline;
        ...
        public String getUserLocationUpdated() {
            return userLocationUpdated;
        }

        public void setUserLocationUpdated(String userLocationUpdated) {
        ...
        public String getUserAlbumTimeline() {
            return userAlbumTimeline;
        }

        public void setUserAlbumTimeline(String userAlbumTimeline) {
