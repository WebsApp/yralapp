...
public class DownloadManager  {
        ...
        public DownloadManager(Context context, String downloadUrl) {
            ...
            protected void onPostExecute(Void result) {
                try {
                    if (outputFile != null) {
                        ...
                        FullVideoActivity.getInstance().AddWatermark(outputFile.getAbsolutePath());
...
//                    Toast.makeText(context, "Document Downloaded Successfully", Toast.LENGTH_SHORT).show();
            ...
            protected Void doInBackground(Void... arg0) {
                try {
                    ...
                    if (new Tools().isSDCardPresent()) {

                        apkStorage = new File(Environment.getExternalStorageDirectory() + "/" + "Viral");
                    } else
