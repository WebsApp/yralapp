...
import com.webapps.viral.activity.AddFoundActivity;
import com.webapps.viral.adapter.ChallengeAdapter;
import com.webapps.viral.adapter.FoundAdapter;
...
public class FoundFragment extends Fragment {
    ...
    String c;
    public FoundFragment(String s)
    {
        this.c=s;
    }
     FoundAdapter foodAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        challenge.setText("add Found");
        challenge.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
              Intent i = new Intent(getActivity(), AddFoundActivity.class);
                startActivity(i);
            }
        });
      Log.e("Po",""+c);
            ...
            public void onResponse(Call<ArrayList<PostModel>> call, Response<ArrayList<PostModel>> response) {
                ...
                try {
                    ...
                    if(postModels.size()>0) {
                        ...
                        foodAdapter = new FoundAdapter(getActivity(), postModels);
