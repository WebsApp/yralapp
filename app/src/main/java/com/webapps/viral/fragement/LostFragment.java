...
import com.webapps.viral.activity.AddLostActivity;
import com.webapps.viral.adapter.ChallengeAdapter;
import com.webapps.viral.adapter.LostAdapter;
...
public class LostFragment extends Fragment {
    ...
    String c;
    public LostFragment(String s)
    {
        this.c=s;
    }
     LostAdapter foodAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        challenge.setText("add Lost");
        challenge.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(getActivity(), AddLostActivity.class);
                startActivity(i);
            }
        });
      Log.e("Po",""+c);
            ...
            public void onResponse(Call<ArrayList<PostModel>> call, Response<ArrayList<PostModel>> response) {
                ...
                try {
                    ...
                    if(postModels.size()>0) {
                        ...
                        foodAdapter = new LostAdapter(getActivity(), postModels);
